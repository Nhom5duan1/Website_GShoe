                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= BASE_URL_ADMIN .  '?act=xoa-danh-muc&id_danh_muc='.$danhMuc['id']?>"><button class="btn btn-danger" onclick="return confirm('Xác Nhận Xóa Vĩnh Viễn Danh Mục.')">Xóa</button></a>
                                        </td>
                                    </tr>
                                    <?php endforeach ?>
                                </tbody>
