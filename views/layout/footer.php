...
<script>
    function handleCheckboxToggle(selectedId, otherId) {
        const selectedCheckbox = document.getElementById(selectedId);
        const otherCheckbox = document.getElementById(otherId);

        if (selectedCheckbox.checked) {
            otherCheckbox.checked = false; // Bỏ chọn checkbox còn lại
        }
    }

    function togglePaymentSection() {
        const checkboxOnline = document.getElementById('checkbox-4');
